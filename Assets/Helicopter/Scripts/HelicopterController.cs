...
public class HelicopterController : MonoBehaviour
{
    ...
    public int ManualTurningForce = 70;
    public float MaxEngineForce = 75;
    public float MinEngineForce = 5;
    ...
    public float EngineForce
    {
        ...
        set
        {
            ...
            if (UIGameController.runtime.EngineForceView != null)
                UIGameController.runtime.EngineForceView.text = string.Format("Engine value [ {0} ] ", (int)EngineForce);
    ...
    public void MaximizeEngineForce()
    {
    ...
    public void ManualTurnRight()
    {
        hMove.x += ManualTurningForce * Time.fixedDeltaTime;
    }

    public void ManualTurnLeft()
    {
        hMove.x -= ManualTurningForce * Time.fixedDeltaTime;
    }
